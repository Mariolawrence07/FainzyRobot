...
import { isObjectEmpty, deepMerge } from "common/utils";
import { logoutAction } from "./StoreActionConfig";
import { FainzyAPI } from "./StoreQueryConfig";
...
const store = configureStore({
  reducer: {
    [FainzyAPI.reducerPath]: FainzyAPI.reducer,
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(
      FainzyAPI.middleware,
      rtkqOnResetMiddleware(FainzyAPI)
    ),
});

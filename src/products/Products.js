        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 gap-5 items-center py-[100px] md:flex-row flex-col z-10 px-5 md:px-2">
          ...
          <div className="flex justify-center">
            <div className="max-w-md">
              ...
              <Typography variant='body2' className='text-gray-400'> (11.78kreviews)</Typography>
              </div>
              ...
              <div className='grid grid-cols-3 gap-3 mt-10'>
                <Button variant="contained" size='large' className='bg-green-600 font-semibold' fullWidth>Added To Cart</Button>
                <Button variant="contained" className='col-span-2 font-semibold' size='large' fullWidth>Added To Cart</Button>
              </div>

              <Button variant="contained" size='large' className='text-black bg-gray-300 mt-5 font-semibold' fullWidth>Added To Cart</Button>
            </div>
          </div>
        </div>
      </header>
